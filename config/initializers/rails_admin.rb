# RailsAdmin config file. Generated on July 13, 2013 10:36
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Lfee Remplacements', 'Admin']
  ...
  # Authorize with CanCan (see models/ability.rb)
  ...
  # config.excluded_models = ['Role', 'Team', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Role', 'Team', 'User']
